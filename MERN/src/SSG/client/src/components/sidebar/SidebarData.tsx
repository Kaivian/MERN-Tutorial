    ...
    items: [
      {
        ...
        iconSize: 31,
        requiredPerms: siteConfig.links.dashboard.requiredPerms,
      },
      {
        key: "grade",
        label: t('links.grade'),
        ...
        iconSize: 31,
        requiredPerms: siteConfig.links.grade.requiredPerms,
      },
      {
        key: "grade/chart",
        ...
        isSubItem: true,
        requiredPerms: siteConfig.links.gradeChart.requiredPerms,
      },
      {
        key: "expense",
        ...
        iconSize: 31,
        requiredPerms: siteConfig.links.expense.requiredPerms,
      }
    ],
  },
  {
    ...
    items: [
      {
        ...
        iconSize: 31,
        requiredPerms: siteConfig.links.calendar.requiredPerms,
      },
      {
        ...
        iconSize: 31,
        requiredPerms: siteConfig.links.deadlineManager.requiredPerms,
      },
    ],
  },
];
